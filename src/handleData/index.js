...
export const addOrUpdateData = async ({ data, userId, trackingNumber }) => Track.updateOne(
  { userId, trackingNumber },
  { trackingNumber, userId, trackInfo: JSON.stringify(data) },
  { upsert: true, setDefaultsOnInsert: true },
);

export const deleteData = async ({ userId, trackingNumber }) => Track.deleteOne(
  { userId, trackingNumber },
);
